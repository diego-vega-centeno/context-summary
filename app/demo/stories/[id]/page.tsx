        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center mb-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                type="button"
                className={`inline-flex items-center justify-center rounded-md text-foreground bg-red-500/50 hover:bg-red-500/80 hover:text-white-500 hover:bg-highlight hover:text-foreground h-8 w-18 px-2 border-1 border-border`}
              >
                Delete
              </button>
            </div>
